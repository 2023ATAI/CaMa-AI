...
def CMF_PHYSICS_ADVANCE(CC_NMLIST, CM_NMLIST, CT_NMLIST ,log_filename, device, Datatype, CU, CC_VARS):
    ...
    def CALC_VARS_PRE(CC_VARS):
        #   ! for river mouth
        RM_Index                                =           torch.arange(1, CM_NMLIST.NSEQMAX + 1)
    ...
    if CC_NMLIST.LADPSTP:           # ! adoptive time step
        ...
        if CC_NMLIST.MODTTEST:
            ...
            CT_NMLIST.test_cost.setdefault('CALC_ADPSTP', []).append(end_moduel - start_moduel)
    ...
    for IT in range (1,CC_NMLIST.NT+1):
        ...
        if CC_NMLIST.LKINE:
            ...
            if CC_NMLIST.MODTTEST:
                end_moduel = time.time()
                CT_NMLIST.test_cost.setdefault('CMF_CALC_OUTFLW', []).append(end_moduel - start_moduel)
            #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
        ...
        if CC_NMLIST.LPTHOUT:
            ...
            #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
                ...
                if CC_NMLIST.MODTTEST:
                    end_moduel = time.time()
                    CT_NMLIST.test_cost.setdefault('CMF_CALC_PTHOUT', []).append(end_moduel - start_moduel)
            #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
        ...
        if CC_NMLIST.MODTTEST:
            end_moduel = time.time()
            CT_NMLIST.test_cost.setdefault('CMF_CALC_INFLOW', []).append(end_moduel - start_moduel)
        #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
        if CC_NMLIST.LDAMOUT:       #   !! reservoir operation
        ...
        if CC_NMLIST.MODTTEST:
            end_moduel = time.time()
            CT_NMLIST.test_cost.setdefault('CMF_CALC_STONXT', []).append(end_moduel - start_moduel)
        #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
        ...
        if CC_NMLIST.MODTTEST:
            end_moduel = time.time()
            CT_NMLIST.test_cost.setdefault('CMF_PHYSICS_FLDSTG', []).append(end_moduel - start_moduel)
        ...
        if CC_NMLIST.MODTTEST:
            end_moduel = time.time()
            CT_NMLIST.test_cost.setdefault('CALC_WATBAL', []).append(end_moduel - start_moduel)
        #  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
