...
def CMF_CALC_PTHOUT(CC_NMLIST, CM_NMLIST, CC_VARS , device, Datatype):
    ...
    RC_Index                        =           torch.arange(0, CM_NMLIST.NPTHOUT, device=device)
    ISEQP                           =           CM_NMLIST.PTH_UPST[RC_Index]-1
    JSEQP                           =           CM_NMLIST.PTH_DOWN[RC_Index]-1
    ...
    DSLP                            =             (CC_VARS.D2SFCELV[ISEQP[ID_M], 0] - CC_VARS.D2SFCELV[JSEQP[ID_M], 0]) / CM_NMLIST.PTH_DST[RC_Index[ID_M]]
    ...
    for ILEV in range(0, CM_NMLIST.NPTHLEV):
        ...
        DFLW                        =               (torch.maximum(CC_VARS.D2SFCELV[ISEQP[ID_M], 0], CC_VARS.D2SFCELV[JSEQP[ID_M], 0])
                                                     - CM_NMLIST.PTH_ELV[RC_Index[ID_M], ILEV])
        DFLW                        =               torch.maximum(DFLW, torch.tensor(0, dtype=Datatype.JPRB, device=device))

        DFLW_pr                     =                (torch.maximum(CC_VARS.D2SFCELV_PRE[ISEQP[ID_M], 0], CC_VARS.D2SFCELV_PRE[JSEQP[ID_M], 0])
                                                     - CM_NMLIST.PTH_ELV[RC_Index[ID_M], ILEV])
    ...
    RATE                                       =                (torch.tensor(0.05,dtype=Datatype.JPRB,device=device) *
                                                                torch.minimum(CC_VARS.D2STORGE[ISEQP[DW_P_M_ID],0], CC_VARS.D2STORGE[JSEQP[DW_P_M_ID],0]) /
    ...
    CC_VARS.D1PTHFLW[RC_Index[DW_P_M_ID],0]    =                CC_VARS.D1PTHFLW[RC_Index[DW_P_M_ID],0] *  RATE
