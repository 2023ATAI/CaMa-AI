...
def CMF_DIAG_RESET_ADPSTP(log_filename, CC_VARS, CT_NMLIST, CC_NMLIST, CM_NMLIST, device, Datatype):
    ...
    CC_VARS.NADD_adp                        =               0
    NQ_Index                                =               torch.arange(0,CM_NMLIST.NSEQMAX)
...
def CMF_DIAG_AVEMAX_ADPSTP(CC_NMLIST,CC_VARS,CM_NMLIST,device):
    ...
    NQ_Index                                 =               torch.arange(0, CM_NMLIST.NSEQMAX, device=device)
    CC_VARS.D2RIVOUT_aAVG[NQ_Index,0]        =               CC_VARS.D2RIVOUT_aAVG[NQ_Index,0]    +   CC_VARS.D2RIVOUT[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2FLDOUT_aAVG[NQ_Index,0]        =               CC_VARS.D2FLDOUT_aAVG[NQ_Index,0]    +   CC_VARS.D2FLDOUT[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2RIVVEL_aAVG[NQ_Index,0]        =               CC_VARS.D2RIVVEL_aAVG[NQ_Index,0]    +   CC_VARS.D2RIVVEL[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2OUTFLW_aAVG[NQ_Index,0]        =               CC_VARS.D2OUTFLW_aAVG[NQ_Index,0]    +   CC_VARS.D2OUTFLW[NQ_Index,0] * CC_NMLIST.DT

    CC_VARS.D2PTHOUT_aAVG[NQ_Index,0]        =               (CC_VARS.D2PTHOUT_aAVG[NQ_Index,0]    +   CC_VARS.D2PTHOUT[NQ_Index,0] * CC_NMLIST.DT  -
                                                             CC_VARS.D2PTHINF[NQ_Index,0] * CC_NMLIST.DT)

    CC_VARS.D2GDWRTN_aAVG[NQ_Index,0]        =               CC_VARS.D2GDWRTN_aAVG[NQ_Index,0]    +   CC_VARS.D2GDWRTN[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2RUNOFF_aAVG[NQ_Index,0]        =               CC_VARS.D2RUNOFF_aAVG[NQ_Index,0]    +   CC_VARS.D2RUNOFF[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2ROFSUB_aAVG[NQ_Index,0]        =               CC_VARS.D2ROFSUB_aAVG[NQ_Index,0]    +   CC_VARS.D2ROFSUB[NQ_Index,0] * CC_NMLIST.DT

    CC_VARS.D2OUTFLW_aMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2OUTFLW_aMAX[NQ_Index,0], torch.abs(CC_VARS.D2OUTFLW[NQ_Index,0]))
    CC_VARS.D2RIVDPH_aMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2RIVDPH_aMAX[NQ_Index,0],          (CC_VARS.D2RIVDPH[NQ_Index,0]))
    CC_VARS.D2STORGE_aMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2STORGE_aMAX[NQ_Index,0],          (CC_VARS.D2STORGE[NQ_Index,0]))
    ...
    if CC_NMLIST.LPTHOUT:
        NO_Index                            =               torch.arange(0, CM_NMLIST.NPTHOUT)
        CC_VARS.D1PTHFLW_aAVG[NO_Index,0]   =               CC_VARS.D1PTHFLW_aAVG[NO_Index,0]    +   CC_VARS.D1PTHFLW[NO_Index,0]  * CC_NMLIST.DT
...
def CMF_DIAG_RESET_OUTPUT(log_filename, CC_VARS, CT_NMLIST, CC_NMLIST, CM_NMLIST, device, Datatype):
    ...
    NT_Index = torch.arange(0, CM_NMLIST.NPTHOUT)
...
def CMF_DIAG_AVEMAX_OUTPUT (CC_NMLIST,CC_VARS,CM_NMLIST,device):
    ...
    NQ_Index                                 =               torch.arange(0, CM_NMLIST.NSEQMAX, device=device)
    CC_VARS.D2RIVOUT_oAVG[NQ_Index,0]        =               CC_VARS.D2RIVOUT_oAVG[NQ_Index,0]    +   CC_VARS.D2RIVOUT_aAVG[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2FLDOUT_oAVG[NQ_Index,0]        =               CC_VARS.D2FLDOUT_oAVG[NQ_Index,0]    +   CC_VARS.D2FLDOUT_aAVG[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2RIVVEL_oAVG[NQ_Index,0]        =               CC_VARS.D2RIVVEL_oAVG[NQ_Index,0]    +   CC_VARS.D2RIVVEL_aAVG[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2OUTFLW_oAVG[NQ_Index,0]        =               CC_VARS.D2OUTFLW_oAVG[NQ_Index,0]    +   CC_VARS.D2OUTFLW_aAVG[NQ_Index,0] * CC_NMLIST.DT

    CC_VARS.D2PTHOUT_oAVG[NQ_Index,0]        =               CC_VARS.D2PTHOUT_oAVG[NQ_Index,0]    +   CC_VARS.D2PTHOUT_aAVG[NQ_Index,0] * CC_NMLIST.DT

    CC_VARS.D2GDWRTN_oAVG[NQ_Index,0]        =               CC_VARS.D2GDWRTN_oAVG[NQ_Index,0]    +   CC_VARS.D2GDWRTN_aAVG[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2RUNOFF_oAVG[NQ_Index,0]        =               CC_VARS.D2RUNOFF_oAVG[NQ_Index,0]    +   CC_VARS.D2RUNOFF_aAVG[NQ_Index,0] * CC_NMLIST.DT
    CC_VARS.D2ROFSUB_oAVG[NQ_Index,0]        =               CC_VARS.D2ROFSUB_oAVG[NQ_Index,0]    +   CC_VARS.D2ROFSUB_aAVG[NQ_Index,0] * CC_NMLIST.DT

    CC_VARS.D2OUTFLW_oMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2OUTFLW_oMAX[NQ_Index,0], torch.abs(CC_VARS.D2OUTFLW_aMAX[NQ_Index,0]))
    CC_VARS.D2RIVDPH_oMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2RIVDPH_oMAX[NQ_Index,0],          (CC_VARS.D2RIVDPH_aMAX[NQ_Index,0]))
    CC_VARS.D2STORGE_oMAX[NQ_Index,0]        =               torch.maximum( CC_VARS.D2STORGE_oMAX[NQ_Index,0],          (CC_VARS.D2STORGE_aMAX[NQ_Index,0]))
    ...
    NO_Index                            =               torch.arange(0, CM_NMLIST.NPTHOUT)
    CC_VARS.D1PTHFLW_oAVG[NO_Index,0]   =               CC_VARS.D1PTHFLW_oAVG[NO_Index,0]    +   CC_VARS.D1PTHFLW_aAVG[NO_Index,0]  * CC_NMLIST.DT
